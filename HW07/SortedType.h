...
public:
  ...
  //hw07-1-b
  void SplitLists(SortedType<ItemType>& list1, SortedType<ItemType>& list2, ItemType item);
...
//hw07-1-b
template <class ItemType>
void SortedType<ItemType>::SplitLists(SortedType<ItemType>& list1, SortedType<ItemType>& list2, ItemType item) {
	NodeType<ItemType>* location = listData;
