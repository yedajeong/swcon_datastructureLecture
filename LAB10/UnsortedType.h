...
private:
  NodeTypeUS<ItemType>* listData;
  int length;
  NodeTypeUS<ItemType>* currentPos;
};
...
{
  NodeTypeUS<ItemType>* location;
  try
  {
    location = new NodeTypeUS<ItemType>;
    delete location;
    return false;
  }
...
{
    NodeTypeUS<ItemType>* location = listData;
    NodeTypeUS<ItemType>* tempLocation;
